...
ostream& operator << (ostream& out, const Employee& employee) {
	out<<"Employee Number: "<<employee.employeeNumber<<", Name: "<<employee.name<<", Adress: "<<employee.address<<", Email: "<<employee.email<<
		", Phone: "<<employee.phone<<", Salary: "<<employee.salary<<", Pay Cheque: "<<employee.payCheque()<<endl; 
	return out;
}
...
ostream& operator << (ostream& out, const RegularEmployee& employee) {
	out<<"Regular Employee Number: "<<employee.employeeNumber<<", Name: "<<employee.name<<", Adress: "<<employee.address<<", Email: "<<employee.email<<
		", Phone: "<<employee.phone<<", Salary: "<<employee.salary<<", Pay Cheque: "<<employee.payCheque()<<endl; 
	return out;
}
...
ostream& operator << (ostream& out, const HourlyContractEmployee& employee) {
	out<<"Hourly Contract Employee Number: "<<employee.employeeNumber<<", Name: "<<employee.name<<", Adress: "<<employee.address<<", Email: "<<employee.email<<
		", Phone: "<<employee.phone<<", Salary: "<<employee.salary<<", Hours: "<<employee.hoursWorked<<", Pay Cheque: "<<employee.payCheque()<<endl; 
	return out;
}
...
ostream& operator << (ostream& out, const OneTimeContractEmployee& employee) {
	out<<"One Time Employee Number: "<<employee.employeeNumber<<", Name: "<<employee.name<<", Adress: "<<employee.address<<", Email: "<<employee.email<<
		", Phone: "<<employee.phone<<", Salary: "<<employee.salary<<", Pay Cheque: "<<employee.payCheque()<<endl; 
	return out;
}
