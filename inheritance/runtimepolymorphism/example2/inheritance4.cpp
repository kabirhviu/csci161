...
class Employee {
	...
	public:
		...
		virtual double payCheque() const = 0;		//Pure virtual functions
		virtual string toString() const = 0;		//Pure virtual functions
...
class RegularEmployee: public Employee {
	public:
		...
		~RegularEmployee();
		double payCheque() const override;
...
string RegularEmployee::toString() const {
	string empStr = "Regular Employee Number: " + employeeNumber + ", Name: " + name + ", Adress: " +
		address + ", Email: " + email + ", Phone: " + phone + 
		", Annual Salary: " + to_string(salary) + ", Pay Cheque: " + to_string(payCheque());
       return empStr;	
...
string HourlyContractEmployee::toString() const {
	string empStr = "Hourly Contract Employee Number: " + employeeNumber + ", Name: " + name + ", Adress: " +
		address + ", Email: " + email + ", Phone: " + phone + 
		", Hourly Salary: " + to_string(salary) + ", Hours Worked: "+ to_string(hoursWorked) + ", Pay Cheque: " + 
		to_string(payCheque());
       return empStr;	
...
string OneTimeContractEmployee::toString() const {
	string empStr = "Ontime Contract Employee Number: " + employeeNumber + ", Name: " + name + ", Adress: " +
		address + ", Email: " + email + ", Phone: " + phone + 
		", Onetime Salary: " + to_string(salary) + ", Pay Cheque: " + to_string(payCheque());
       return empStr;	
...
int main() {
	...
	/*
	 * Since Employee is now an abstract class, you are not allowed to create objects from Employee class.
	 */
	//Employee employee0;
	//cout<<employee0<<endl;
	...
	/*
	 * You can create objects from non-abstract classes
	 */
	cout<<"Regular Objects from non-abstract subclasses.........................................."<<endl;
	...
	cout<<endl;
	cout<<"Objects from non-abstract subclasses with abstract base class references (pointers) to achieve runtime polymorphism"<<endl;
	cout<<"************************************************************************************************************"<<endl;
	Employee* employees[] = {
