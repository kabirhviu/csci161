...
int main(){
  ...
  /*
   * The above code can be reused to test LinkedListStack through polymorphic 
   * reference stack and for that reason, tested does not to repeat following codes
   * to test LibkedListStack class.
   */
